...
describe('Module - Export', () => {
  const inValids: Array<[string, Context]> = [
    ...
    // ['var mustExist; export {mustExist as canBeUndeclared};', Context.Strict | Context.Module],
    // ['var canBeUndeclared; export {mustExist as canBeUndeclared};', Context.Strict | Context.Module],
