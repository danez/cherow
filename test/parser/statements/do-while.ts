...
const valids: Array < [string, Context, any] > = [
  ...
  ['do{ break; } while(function __func(){return 1;});', Context.Empty, {
    "type": "Program",
    "body": [
        {
   ...
   [`do { __condition++; if (((""+__condition/2).split(".")).length>1) continue; __odds++;} while(__condition < 10)`, Context.Empty, {
    "type": "Program",
    "body": [
        {
            "type": "DoWhileStatement",
  ...
  ['do continue; while(1);', Context.Empty, {
    "type": "Program",
    "body": [
        {
            "type": "DoWhileStatement",
  ...
  ['{do ; while(false); false}', Context.Empty, {
    "type": "Program",
    "body": [
        {
            "type": "BlockStatement",
