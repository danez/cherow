...
const valids: Array < [string, Context, any] > = [
  ['for (let foo, bar;;);', Context.OptionDisablesWebCompat, {
    "type": "Program",
    "body": [
        {
            "type": "ForStatement",
  ...
  ['for (let foo = bar, zoo = boo;;);', Context.OptionDisablesWebCompat, {
    "type": "Program",
    "body": [
        {
            "type": "ForStatement",
  ...
  ['for (let\nfoo;;);', Context.OptionDisablesWebCompat, {
      "body": [
        {
          "body": {
            "type": "EmptyStatement"
...
/*  ['for (let [foo, bar=b] = arr;;);', Context.OptionDisablesWebCompat, {
 ...
 /* ['for (let [foo=a, bar=b] in arr);', Context.OptionDisablesWebCompat, {
  ...
  ['for (let foo in x);', Context.OptionDisablesWebCompat, {
    "type": "Program",
    "body": [
        {
            "type": "ForInStatement",
  ...
  ['for (let foo;;);', Context.OptionDisablesWebCompat, {
    "type": "Program",
    "sourceType": "script",
    "body": [
      {
